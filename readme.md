...
отформатирован с помощью Prettier Стартовые файлы
...
Категория: Животные Количество элементов: 4 Задание 2
...
alt: 'Group of Horses Running', }, ]; Задание 4
...
#validation-input.invalid { border-color: #f44336; } Задание 7
